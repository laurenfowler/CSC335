...
* Define program variables
      ...
      double precision x(0:MAXPTS), y_interp(0:MAXPTS)
      double precision xtmp, ytmp, xmin, xmax, delx, temp, maxy
...
* Nom compute values of interpolating polynomial
      ...
      do 30 i = 1, MAXVAL
         y_interp(i) = interp(numpts, xpt, ypt, x(i) )
